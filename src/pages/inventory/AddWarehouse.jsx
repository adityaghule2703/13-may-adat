...
//         setTimeout(() => navigate('/warehouses'), 2000);
//       } else {
//         const errorMessage = response.data.message || response.data.error || t('warehouses.errors.createFailed');
//         showError(errorMessage);
//       }
//     } catch (error) {
//       console.error('Error creating warehouse:', error);
...
//             }}
//           >
//             {loading ? <CircularProgress size={16} sx={{ color: 'white' }} /> : <><SaveIcon sx={{ fontSize: '1rem', mr: 0.5 }} /> {t('common.create')}</>}
//           </Button>
//         )}
//       </Box>
//     </Box>
